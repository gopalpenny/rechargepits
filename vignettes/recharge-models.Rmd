...
$$
where the only new variable is $x_f$, the horizontal distance from the soil boundary to the wetting front. Note that $x_f$ is not present in the numerator. This equation becomes:
...
We further note that $\frac{\partial r_f}{\partial t} = \frac{Q}{2 \pi r_f \Delta \theta}$. Plugging in the equation for $Q$ and rearranging, we obtain:
$$
...
$$
r_f = \sqrt{F_r \frac{\Delta \theta}{\pi} + r_b^2}
$$


## Spherical flow without gravity
